  ...
  return (
    <section className='flex flex-col items-center w-full h-full'>
      <div className='h-[20rem] w-full flex relative overflow-hidden group text-center'>
        <h1 className='text-6xl font-semibold z-50 items-center justify-center flex w-full uppercase text-white group-hover:opacity-0 transition duration-500'>{place.name}</h1>
