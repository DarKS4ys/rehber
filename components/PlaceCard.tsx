...
const pathname = usePathname()
  return (
    <Link href={`${pathname}/places/${place.id}`} className='dark:shadow-none shadow pb-4 group relative flex flex-col gap-4 w-full items-center text-center border border-border hover:border-primary/80 rounded-xl hover:scale-105 transition duration-200 overflow-hidden'>
